import OkSignIcon from "../assets/svgComponents/OkSignIcon";
    ...
    return (
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img className="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src={featureImageOne} alt="dashboard feature image" />                
            </div>

            {/* <!-- Sub Service 2 --> */}
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img className="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src={featureImageTwo} alt="feature image 2" />
                <div className="text-gray-500 sm:text-lg dark:text-gray-400">
